...
<div class="full-width-split group">
    <div class="full-width-split__one">
        <div class="full-width-split__inner">
            <h2 class="headline headline--small-plus t-center">Upcoming Seminars</h2>
            <?php
            $today = date('Ymd');
            $homePageSeminars = new WP_Query(array(
                'posts_per_page' => 2,
                'post_type' => 'seminar',
            ...
            while ($homePageSeminars->have_posts()) {
                $homePageSeminars->the_post(); ?>
            ...
            <?php }
            ?>
            <p class="t-center no-margin"><a href="<?php echo get_post_type_archive_link('seminar') ?>"
    ...
    <div class="full-width-split__two">
        <div class="full-width-split__inner">
            <h2 class="headline headline--small-plus t-center">From Our Articles</h2>
            <?php
